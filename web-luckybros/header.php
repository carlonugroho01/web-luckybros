...
<head>
    ...
    <title>Luckybros - Auction Site</title>
    ...
    <link href="css/styles.css?d=<?php echo time(); ?>" rel="stylesheet" />
</head>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand js-scroll-trigger" href='index.php'><img src="assets/img/unnamed.png" alt="" /></a>
